...
2. **Tomasulo, An Efficient Algorithm for Exploiting Multiple Arithmetic Units** (1967) — out-of-order execution. → *instruction-level-parallelism*
...
8. **Lindholm et al., NVIDIA Tesla** (2008) — the SIMT GPU. → *accelerators-and-warehouse-scale*
9. **Barroso & Hölzle, The Datacenter as a Computer** (2009) — warehouse-scale computing. → *accelerators-and-warehouse-scale*
...
11. **Jouppi et al., In-Datacenter Performance Analysis of a TPU** (2017) — the ML accelerator. → *accelerators-and-warehouse-scale*
12. **Kocher et al., Spectre Attacks** (2019) — speculative-execution side channels. → *tools-and-security*
